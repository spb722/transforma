...
<img src="assets/banner.png" alt="transforma" width="720">
...
<br>
![GitHub last commit](https://img.shields.io/github/last-commit/spb722/transforma?style=flat-square)
[![GitHub stars](https://img.shields.io/github/stars/spb722/transforma?style=flat-square)](https://github.com/spb722/transforma/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/spb722/transforma?style=flat-square)](https://github.com/spb722/transforma/issues)
...
>
> A fork of [spb722/transforma](https://github.com/spb722/transforma) that adds one
...
>
> Everything else is upstream transforma. With the Coach switched off, this is byte-for-byte the
> app it forked from.
>
...
> [design deck (PDF)](transforma_AI_Strategy.pdf)
...
### [🌐 github.com/spb722/transforma/releases](https://github.com/spb722/transforma/releases) · [▶ Try the live demo](https://spb722.github.io/transforma/)
...
disappear when the startup does. transforma is the opposite: **it runs on your box, your data
...
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders ([download](https://github.com/spb722/transforma/releases))
...
- **Android:** [**download the APK**](https://github.com/spb722/transforma/releases) and sideload it —
  transforma is deliberately not on the Play Store. Or build it yourself: **[docs/MOBILE.md](docs/MOBILE.md)**.
...
| `RP_NAME`     | Name shown in the passkey prompt                     | `transforma`            |
...
- [x] Standalone mobile app — Android APK to sideload ([download](https://github.com/spb722/transforma/releases)); on iOS as a self-hosted PWA (no store listings planned)
...
- **[Q&A](https://github.com/spb722/transforma/discussions/categories/q-a)** — self-hosting
  help, passkey/login trouble, "how do I…". Most login problems turn out to be an `RP_ID`/`ORIGIN`
  mismatch.
- **[Ideas](https://github.com/spb722/transforma/discussions/categories/ideas)** — features
  worth talking through before anyone writes code.
- **[Show and tell](https://github.com/spb722/transforma/discussions/categories/show-and-tell)**
  — your setup, your plan templates, whatever you built on top.
- **[Issues](https://github.com/spb722/transforma/issues)** — bugs, and work that's already
  been agreed on.
...
transforma is free and stays free: AGPL, no subscription, no paid tier, nothing held back for
...
the same license. Nobody can turn transforma into a closed, proprietary product.
