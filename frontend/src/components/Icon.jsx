// transforma icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  shieldCheck: <><path d="M12 3.6 5 6.2v5.5c0 4 2.9 7.5 7 8.7 4.1-1.2 7-4.7 7-8.7V6.2Z" /><path d="m9.2 12.2 2 2 3.6-3.8" /></>,
  ...
  arrowRight: <path d="M4.4 12h15.2M13.4 6.2l6.2 5.8-6.2 5.8" />,
  ...
  /* responsive-ui-redesign additions — conflict/error and offline states (T013) */
  warning: <><path d="M12 4.4 3.3 19.6h17.4Z" /><path d="M12 10v4.4" /><circle cx="12" cy="16.6" r=".9" fill="currentColor" stroke="none" /></>,
  wifiOff: <><path d="M4.9 9.5a10 10 0 0 1 14.2 0" /><path d="M7.8 12.6a6 6 0 0 1 8.4 0" /><path d="M10.7 15.7a2 2 0 0 1 2.6 0" /><circle cx="12" cy="18.2" r=".9" fill="currentColor" stroke="none" /><path d="M4 4.6 20 19.4" /></>,
}
