...
import { Button, Switch, TextField, Skeleton } from '../components/ui.jsx'
...
export default function AdminCoach() {
  ...
  if (!d) return <div className="card" style={{ display: 'grid', gap: 10 }}>
...
function ChatGPTLoginSheet({ close, onDone, label }) {
  ...
  return <>
    <h3>Connect {label}</h3>
    <div className="muted small" style={{ lineHeight: 1.5, marginBottom: 12 }}>
      This starts Codex&apos;s official ChatGPT device-code sign-in inside the private Coach runtime. On your iPad or another trusted browser, open the link and enter the one-time code it shows. No API key is used or stored by transforma.
    </div>
