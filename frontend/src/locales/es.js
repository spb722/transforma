...
export default {
  ...
  "This browser doesn't support passkeys — you can still use transforma locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar transforma localmente en este dispositivo.',
  ...
  'to install transforma as a full-screen app.': 'para instalar transforma como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if transforma is closed.': 'Avisos del temporizador de descanso, incluso con transforma cerrado.',
  ...
  'A small file a friend imports into their own transforma — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio transforma: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload transforma': 'Recargar transforma',
  ...
  'Self-host transforma': 'Aloja transforma tú mismo',
