# Contributing to transforma

Thanks for taking a look! transforma is intentionally small and dependency-light, and the goal is
...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [Discussions → Q&A](https://github.com/spb722/transforma/discussions/categories/q-a) |
| An idea you're not sure about yet | [Discussions → Ideas](https://github.com/spb722/transforma/discussions/categories/ideas) |
| A reproducible bug | [Issues](https://github.com/spb722/transforma/issues) |
