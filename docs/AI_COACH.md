...
The feature this fork adds to [transforma](https://github.com/spb722/transforma): an optional AI
...
Upstream transforma progresses a plan flawlessly and cannot write one. The engine adjusts weights
...
- **Your box, your data.** The provider runs locally; transforma ships no bundled API keys.
...
needs an API key. transforma never handles a browser OAuth callback and never asks your users for
credentials.
...
- **[transforma_AI_Strategy.pdf](../transforma_AI_Strategy.pdf)** — the functional description and
